...
from utils.utils import load_state_dict, LossMeter, set_global_logging_level
import wandb
...
class TrainerBase(object):
    ...
    def create_config(self):
        ...
        elif 'bert' in self.args.backbone:
        ...
        config.radical_vocab_size = self.rid
        print('radical vocab size: {}'.format(self.rid))
        config.eg = args.eg
        config.cl = args.cl
        config.eg_only = args.eg_only
    ...
    def create_optimizer_and_scheduler(self):
        ...
        if 'adamw' in self.args.optim:
            ...
            # lr_scheduler = WarmupLinearSchedule(optim, warmup_iters, t_total)
    ...
    def load_checkpoint(self, ckpt_path):
        ...
        results = self.model.oribert.load_state_dict(state_dict, strict=False)
        if self.verbose:
