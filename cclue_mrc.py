...
from cclue.cclue_mrc_data import get_loader
from cclue.cclue_mrc_model import BertDictMRC
...
class Trainer(TrainerBase):
    ...
    def train(self):
        ...
        if self.verbose:
            ...
            evaluator.dump_result(quesid2ans, os.path.join(self.args.output, 'predict_baseline.json'))
