...
def parse_args(parse=True, **optional_kwargs):
    ...
    parser.add_argument("--radical_path", default=None)
    parser.add_argument("--glyph", type=str, default='none')
    ...
    parser.add_argument('--embedding_lookup_table', type=str, default=None)
