...
from cclue.cclue_sl_data import get_loader
from cclue.cclue_sl_model import BertDictSL
...
class Trainer(TrainerBase):
    ...
    def train(self):
        ...
        for epoch in range(self.args.epochs):
            ...
            if self.verbose:
                valid_score = score_dict['f1'] * 100.
                valid_score_raw = score_dict['f1']
            ...
            if self.verbose:
                test_score = score_dict['f1'] * 100.
                test_score_raw = score_dict['f1']
                # valid_score = score_dict['topk_score'] * 100.
                # valid_score_raw = score_dict['overall']
        ...
        if self.verbose:
            ...
            acc, prec, recl, f1 = evaluator.evaluate(quesid2ans)
            print(f'The F1. of the best ckpt. for predict result is: {f1}')
    ...
    def evaluate(self, loader, dump_path=None):
        ...
        if self.verbose:
            ...
            acc, prec, recl, f1 = evaluator.evaluate(textid2ans)
            # acc_dict['topk_score'] = topk_score
            acc_dict = {'accuracy':acc, 'precision':prec, 'recall':recl, 'f1':f1}
